...
| `STEADYBIT_EXTENSION_REQUEST_TIMEOUT`                        | via extraEnv variables                   | Timeout for Prometheus query responses (e.g., `10s`, `30s`). Increase for slow or heavily loaded Prometheus instances. Defaults to `10s`.                                                                                            | no       |
